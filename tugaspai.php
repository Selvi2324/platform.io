...
<head>
    ...
    <title>Upload Tugas Pendidikan Agama Islam</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100 p-6">
    <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-md">
        <h2 class="text-xl font-semibold text-gray-900 mb-4">Tugas PKK</h2>

        <form action="tugaspkk.php" method="post" enctype="multipart/form-data">
