...
$sql = "SELECT id, nama_siswa, file_path, waktu FROM tugas WHERE mata_pelajaran = 'Bahasa Inggris' ORDER BY waktu DESC";
...
<head>
    ...
    <title>Daftar Tugas Bahasa Inggris</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" rel="stylesheet"/>
</head>
<body class="bg-gray-100 p-6">
    <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md">
        <h2 class="text-xl font-semibold text-gray-900 mb-4">Daftar Tugas Bahasa Inggris</h2>
